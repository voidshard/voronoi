...
// Notes.
// 1. the behaviour of this is undefined if the same site is in both inside & outside
...
func Circut(bnds image.Rectangle, inside, outside []Site) [][2]image.Point {
...
func deletionMethod(bnds image.Rectangle, inside, outside []Site) [][2]image.Point {
